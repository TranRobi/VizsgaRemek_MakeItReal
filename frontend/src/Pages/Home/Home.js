      ...
      <div className="w-4/5 mx-auto py-12">
        ...
        <section className="bg-[#D3C5B8] p-8 rounded-lg shadow-lg mb-12 flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-1/2">
            ...
            <NavLink to="/aboutus" className="mt-4 inline-block bg-[#333333] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#5A738E] transition">
        ...
        <section className="bg-[#D3C5B8] p-8 rounded-lg shadow-lg mb-12 flex flex-col md:flex-row-reverse items-center gap-8">
          <div className="md:w-1/2">
            ...
            <NavLink to="/contactus" className="mt-4 inline-block bg-[#333333] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#5A738E] transition">
              Contact us now <ArrowForwardIcon className="ml-2" />
            </NavLink>
          </div>
          <img src="contactImg.png" alt="Contact us" className="w-full md:w-1/2 rounded-lg shadow-lg"/>
        </section>
        ...
        <section className="bg-[#D3C5B8] p-8 rounded-lg shadow-lg text-center mb-12">
            ...
            <NavLink to="/order" className="mt-4 inline-block bg-[#333333] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#5A738E] transition">
